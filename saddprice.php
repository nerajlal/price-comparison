...
<form method="POST"  enctype="multipart/form-data" >
  <table style="color:white;">
    <tr>
      <td>Shop Name</td><td><input type="text" name="pname" class="form-control" style="margin-bottom: 8px;margin-left: 8px" required></td>
    </tr>
    <tr>
...
if(isset($_POST['submit'])){
  ...
  $q="INSERT into price(platform,email,p_category,p_company,p_model,price,link,photo) values('$name','$uname','$aadharno','$phno','$model','$price','$link','$target_file')";
  //echo $q;
  if(mysql_query($q,$conn))
  {
    
          echo "<script>alert('Price Added!');
              location.href='saddprice.php';
          </script>";
  }
  else
  {
